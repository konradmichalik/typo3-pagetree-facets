...
- **Built-in filter tabs**: Content elements (`ce:`), Records (`table:` `record:` `text:`), Activity (`updated:` `created:` `by:`), Page type (`doktype:`), Page state (`is:`), Missing translations (`untranslated:`), SEO (`seo:`, requires EXT:seo)
